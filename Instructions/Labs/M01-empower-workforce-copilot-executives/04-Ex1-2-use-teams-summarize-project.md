...
## Task 2: Use Copilot in a Teams Chat Session to Summarize a Project Discussion
...
1. In **Teams for the web**, select **Chat** from the left navigation pane.

2. Open the **Project Nexus** group chat.

   > **Note:** A sample **Project Nexus** group chat containing project-related discussions has been preconfigured for this lab.

3. Select the **Copilot** icon in the upper-right corner of the chat window.
...
6. Select and submit a starter prompt that interests you, such as:
...
## Analyze Contributions from a Specific Participant
...
2. Replace **{name of the person}** with the name of a participant in the **Project Nexus** chat.

   Example:

   ```text
   What did Alex Wilber say?
   ```
...
5. Select one of the citation references associated with a highlighted statement.

6. Observe how Teams navigates directly to the original message posted by that individual.

7. Review additional citations to better understand that participant's contributions to the discussion.

### Expected Outcome

Copilot identifies key contributions made by the selected participant and provides citations that allow you to quickly locate the original messages in the chat history.
...
- Use Copilot in Teams chats to summarize lengthy discussions.
- Leverage Copilot starter prompts to explore project conversations.
- Use citations to navigate directly to source messages.
- Identify decisions, action items, and discussion highlights.
- Analyze contributions from specific participants within a chat conversation.
- Improve productivity by quickly understanding project communications without manually reviewing entire chat histories.
