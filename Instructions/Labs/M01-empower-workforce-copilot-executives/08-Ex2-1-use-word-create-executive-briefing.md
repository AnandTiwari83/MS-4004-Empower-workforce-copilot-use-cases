...
4. Review the recommendations generated by Copilot.
   ...
   > **Note:** If **Allow editing** is enabled, Copilot may automatically insert the generated content directly into the document. If the content isn't automatically added, continue with the following steps to copy and insert the recommendations manually.

5. Select **Copy response**.

6. Insert the content into the document at an appropriate location.
...
4. If satisfied with the visualization, select **Copy response**.

5. Paste the chart into an appropriate section of the report.
