...
2.  In the **Market Research Agent**, enter the following prompt **(1)**:

    ```
    Market insights report
    ```

3.  In the response **(2)**, it will likely ask you to specify a product category to focus the report on. Enter the product category in the prompt **(3)**:

    ```
    Smart workspace products in the commercial office market 
    ```
