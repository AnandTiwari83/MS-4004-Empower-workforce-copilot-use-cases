...
2. Save the downloaded file to your **OneDrive** account so it is accessible to Copilot in your Microsoft 365 tenant.
   ...
   - If the file downloads to the local machine first, upload it to **OneDrive > My files** before proceeding.
   - Confirm the file name remains **EcoSmart COGS Estimates.xlsx** so it is easy to identify later.
...
1. In Microsoft Edge, navigate to the **Microsoft 365 home page**: `https://www.microsoft365.com`
   ...
   - If you are not already signed in, use your lab-provided Microsoft 365 account.

2. Select **Apps** in the left navigation pane, then select **Excel**.

   - If the navigation pane is collapsed, expand it first or use the Microsoft 365 app launcher to find **Excel**.
...
4. Navigate to your **OneDrive** account and select the **EcoSmart COGS Estimates** spreadsheet.
   ...
   - In the file picker, browse to **OneDrive** → **My files** → **EcoSmart COGS Estimates.xlsx**, then select **Open**.

> **📸 Screenshot placeholder:** Capture the **EcoSmart COGS Estimates.xlsx** workbook open in Excel for the web.  
> Suggested filename: `M05-Lab03-Step01-ExcelFileOpen.png`

5. Once the file opens, select **Copilot** on the **Home** tab ribbon.

   - The **Copilot** button is typically on the right side of the **Home** ribbon.

> **📸 Screenshot placeholder:** Capture Excel with the **Copilot** pane open on the right side.  
> Suggested filename: `M05-Lab03-Step02-ExcelCopilotPaneOpen.png`
...
> **📸 Screenshot placeholder:** Capture the Copilot prompt field with the **Edit with Copilot** icon visible.  
> Suggested filename: `M05-Lab03-Step03-EditWithCopilotIcon.png`

> ✅ **Checkpoint:** The Edit with Copilot icon should now be visible in the Copilot prompt field.

> **🔧 Troubleshooting:**
> - If the **Edit with Copilot** icon is not visible, select the **(+) sign** in the Copilot prompt field → choose **Edit with Copilot** from the menu.
> - If Copilot does not recognize the file, close and reopen the file from OneDrive.
> - If the Copilot button is greyed out on the ribbon, ensure your Microsoft 365 account has Copilot enabled.
> - If Copilot creates content in the existing sheet instead of a new one, explicitly add "in a new sheet" to your prompt.
...
> **📸 Screenshot placeholder:** Capture the new sheet that describes the dataset columns and highlights any data quality issues.  
> Suggested filename: `M05-Lab03-Step04-DatasetDescriptionSheet.png`
...
> **📸 Screenshot placeholder:** Capture the sheet that summarizes cost trends, averages, or patterns across the EcoSmart dataset.  
> Suggested filename: `M05-Lab03-Step05-CostPatternsSheet.png`
...
> **📸 Screenshot placeholder:** Capture the outliers or anomalies analysis sheet generated by Copilot.  
> Suggested filename: `M05-Lab03-Step06-OutliersAnalysisSheet.png`
...
> **📸 Screenshot placeholder:** Capture the sheet that summarizes the top cost drivers and cost reduction opportunities.  
> Suggested filename: `M05-Lab03-Step07-CostDriverSummarySheet.png`
...
> **📸 Screenshot placeholder:** Capture the bar chart sheet showing the top five cost drivers by average COGS.  
> Suggested filename: `M05-Lab03-Step08-BarChartTopCostDrivers.png`
...
Before moving to **Lab-04**, confirm the following:

- [ ] I can reopen **EcoSmart COGS Estimates.xlsx** from **OneDrive** in Excel for the web.
- [ ] I verified that the **Copilot** pane opens and **Edit with Copilot** is available.
- [ ] I created or reviewed the sheets for dataset description, cost trends, outliers, cost drivers, and the bar chart.
- [ ] I am ready to discuss these outputs in the meeting-focused workflow that continues in **Lab-04**.
