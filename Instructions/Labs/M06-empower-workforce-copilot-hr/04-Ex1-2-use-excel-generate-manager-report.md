...
5. Return to the manager performance sheet that Copilot created earlier. You now want to export this sheet as a PDF file that you can email to leadership in Task 3 and use in your planning session in Task 4. To export this data sheet, select **File (1) > Export (2) > Download as PDF (3)** (or it might say **Create PDF/XPS Document)**. 
