...
1. Click on the **+** icon and select **Attach cloud files** and selcet the pdf you have uploaded the onedrive in previous exercise.
...
1. When you're satisfied with the draft, select **Keep it** or **Replace** to insert the content into the actual email body.
...
1. Review the inserted email. If you want to change the tone, highlight the email text, reopen Copilot, and select **Change Tone**.
    ...
    ```
    Rewrite this email in a professional and informative tone that is clear, concise, and appropriate for distribution center staff. Maintain all key safety information and action items.
    ```
