...
1. In your Microsoft Edge browser, select the following link to download the **AuroraHub Product Overview.docx** file:

   **[https://go.microsoft.com/fwlink/?linkid=2347805](https://go.microsoft.com/fwlink/?linkid=2347805)**

2. Save the downloaded file to your **OneDrive** account.
...
4. Sign in using the credentials provided by your lab environment.

5. In the navigation pane, select **Apps** and then select **Word**.

6. In **Word for the web**, select **Blank document**.

7. On the **Home** tab, select **Copilot**.

8. Verify that **Edit with Copilot** is enabled in the Copilot pane.

   > **Note:** If the **Edit with Copilot** icon isn't displayed, select the **+** icon and then choose **Edit with Copilot**.

9. In the Copilot prompt box, attach the **AuroraHub Product Overview.docx** file from OneDrive.
...
11. Review the communication brief generated by Copilot.
