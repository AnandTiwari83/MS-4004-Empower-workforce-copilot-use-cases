...
3. Review Researcher’s findings. Then ask Copilot to draft a multiple page **Risk Brief document**.
    ...
    ```
    Draft a one to two page Risk Brief document that summarizes these findings in plain language for executives.
    ```
...
8.  Ask Researcher to turn this risk brief into a downloadable Word document. If Researcher creates the document, then save it to your OneDrive as **Boulder Risk Brief – Executive Summary.docx**.
    ...
    - Select the **Edit in Pages** icon that appears at the end of the content.
    
    - Review the generated content on the **Pages** form. Feel free to make any changes to the headings or any other content on the form.
